...
<div class="p-3 ml-6 mr-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
  ...
  <ul id="defaultTab" role="tablist"
      ...
      <li class="me-2">
          <button id="detail-tab"
                  data-tabs-target="#detail"
                  type="button"
                  role="tab"
                  aria-controls="detail"
                  aria-selected="true"
                  class="inline-block p-4 text-blue-600 bg-gray-100 rounded-t-lg dark:bg-gray-700 dark:text-blue-500">
              Detail
          </button>
      </li>
      <li class="me-2">
          <button id="gambar-tab"
  ...
  <div id="defaultTabContent">
      ...
      <div id="detail"
           ...
           class="block p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800">
      ...
      <div id="gambar"
          ...
          <figure class="flex flex-col items-center justify-center max-w-lg mx-auto">
              @if ($barang->foto)
                  <img class="h-auto w-64 rounded-lg shadow-md border border-gray-200 dark:border-gray-700"
      ...
      <div id="qrcode"
          ...
          <figure class="flex flex-col items-center justify-center max-w-lg mx-auto">
              @if ($barang->qr_code)
                  <img class="h-auto w-48 rounded-lg shadow-md border border-gray-200 dark:border-gray-700"
                       src="{{ asset('storage/' . $barang->qr_code) }}"
                       alt="QR Code">
              @else
                  <div class="w-48 h-48 flex items-center justify-center bg-gray-100 text-gray-500 rounded-lg border dark:bg-gray-700 dark:text-gray-400">
                      Tidak ada QR Code
                  </div>
              @endif
              <figcaption class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    tabs.forEach(tab => {
        tab.addEventListener('click', () => {
            ...
            // Reset semua tab header
            tabs.forEach(t => {
                t.classList.remove('text-blue-600', 'dark:text-blue-500', 'bg-gray-100', 'dark:bg-gray-700');
            });

            // Tambahkan kelas aktif ke tab terpilih
            tab.classList.add('text-blue-600', 'dark:text-blue-500', 'bg-gray-100', 'dark:bg-gray-700');
        });
    });
});
</script>

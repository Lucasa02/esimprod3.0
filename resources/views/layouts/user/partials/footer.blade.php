<footer
  ...
  <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; ESIMPROD TVRI KALIMANTAN SELATAN 2022 - {{ date('Y') }}
  </span>
  <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
    <li>
      <a href="{{ asset('storage/uploads/guidebook/' . $file->file) }}" target="_blank"
        class="hover:underline me-4 md:me-6">Panduan Admin</a>
    </li>
    <li>

...
Route::prefix('studio2')->name('studio2.')->group(function () {
    ...
    Route::post('/', [Studio2Controller::class, 'store'])->name('store');
    Route::get('/{id}/edit', [Studio2Controller::class, 'edit'])->name('edit');
    Route::put('/{id}', [Studio2Controller::class, 'update'])->name('update');
    Route::delete('/{id}', [Studio2Controller::class, 'destroy'])->name('destroy');
    Route::get('/{id}', [Studio2Controller::class, 'show'])->name('show');

    // ✅ Diperbaiki: hapus "studio2/" di depan
    Route::get('/{id}/detail', [Studio2Controller::class, 'show'])->name('detail');
    Route::get('/print/data', [Studio2Controller::class, 'print'])->name('print');
});
